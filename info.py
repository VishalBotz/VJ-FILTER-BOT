...
API_ID = int(environ.get('API_ID', '20492556'))
API_HASH = environ.get('API_HASH', '43bea549b00395cf3f15f822057d0acb')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', ' -1002008661740'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1834715690').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002107447691').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# auth_channel means force subscribe channel.
auth_channel = environ.get('AUTH_CHANNEL', '-1002089156885') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('support_chat_id', '-1002073880338')
reqst_channel = environ.get('reqst_channel', '-1002135488005')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://vijaykumarprince345:tNwPGpBcuN0pUkGa@cluster0.qlf3qck.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "vijaykumarprince345")
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', '@GogB1Tc') # owner username without @

# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/MagicOfGroup')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Muskaan_Update_Channal')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_to_Open_Link_33/21')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/How_to_Open_Link_33/21')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Muskaan_filter_bot_Support_Group') # Support Chat Link Without https:// or @
...
USE_CAPTION_FILTER = bool(environ.get('<b><a href="https://telegram.me/wideanglemedia">{caption}</a></b>', True))

# Shortlink Info
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'ziplinker.net')
SHORTLINK_API = environ.get('SHORTLINK_API', '12eb024ec60162624a4551fba7f3e2bb4d4b7abc')
